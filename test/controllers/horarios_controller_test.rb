...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { data: @horario.data, dia_semana: @horario.dia_semana, entidade_id: @horario.entidade_id, hora_fim: @horario.hora_fim, hora_inicio: @horario.hora_inicio }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { data: @horario.data, dia_semana: @horario.dia_semana, entidade_id: @horario.entidade_id, hora_fim: @horario.hora_fim, hora_inicio: @horario.hora_inicio }
    assert_redirected_to horario_path(assigns(:horario))
  end
