...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { descricao: @servico.descricao, entidade_id: @servico.entidade_id, nome: @servico.nome, preco: @servico.preco, status: @servico.status, tempo: @servico.tempo }
    end
  ...
  test "should update servico" do
    patch :update, id: @servico, servico: { descricao: @servico.descricao, entidade_id: @servico.entidade_id, nome: @servico.nome, preco: @servico.preco, status: @servico.status, tempo: @servico.tempo }
    assert_redirected_to servico_path(assigns(:servico))
  end
